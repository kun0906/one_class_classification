...
class OCSVM(object):
    ...
    def __init__(self, kernel='rbf', grid_search_cv_flg=False, show_flg=False, **kwargs):
        """
...
def ocsvm_main(input_files_dict, kernel='rbf', out_dir='./log', show_flg=False, **kwargs):
    """
    ...
    evaluate_model_new(ocsvm_model, test_set_without_abnormal_data, u_normal, std_normal,
                       test_files_lst=input_files_dict['attack_files'], label='0')
